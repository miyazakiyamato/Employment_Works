...
std::vector<D3D12_ROOT_PARAMETER> SkyboxPipeline::RootParameters(const std::vector<D3D12_DESCRIPTOR_RANGE>& descriptorRanges) {
...
std::vector<D3D12_INPUT_ELEMENT_DESC> SkyboxPipeline::InputElementDesc(){
